...
INSERT INTO book(id, title, category, price, rating, stock) VALUES (13, 'It''s Only the Himalayas', "Travel", 45.17, 2, 19)
...
UPDATE book
set stock = 22 + 5
WHERE title = 'A Light in the Attic';

UPDATE book
set stock = 19 + 5
WHERE title = 'The Black Maria';

UPDATE book
set stock = 18 + 5
WHERE title = 'Shakespeare''s Sonnets';
