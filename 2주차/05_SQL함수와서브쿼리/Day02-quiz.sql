...
/* -------------------------------------------------------------------
   ...
   ------------------------------------------------------------------- */
SELECT SupportRepId, COUNT(*) AS customers_count
FROM customers
...
/* -------------------------------------------------------------------
   ...
   ------------------------------------------------------------------- */
SELECT a.Name AS track_name, b.Name AS media_type
FROM tracks a
JOIN media_types b ON a.MediaTypeId = b.MediaTypeId
;
...
/* -------------------------------------------------------------------
   ...
   ------------------------------------------------------------------- */
SELECT InvoiceId, Total, BillingCountry, LastName, FirstName
FROM invoices i
...
/* -------------------------------------------------------------------
   ...
   ------------------------------------------------------------------- */
SELECT a.Name AS playlist_name, t.Name AS track_name
FROM playlists a
